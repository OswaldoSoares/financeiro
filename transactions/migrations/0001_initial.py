# Generated by Django 5.0.2 on 2024-06-30 20:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("obs", models.TextField(blank=True, max_length=120)),
                (
                    "category_n1",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="category_n1",
